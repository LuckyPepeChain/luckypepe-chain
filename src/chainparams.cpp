...
{
    const char* pszTimestamp = "LuckyPepe Genesis - 2026";
...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 1296;
        ...
        genesis = CreateGenesisBlock(1740000000, 33, 0x2000ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9eda720c8cef4c8fe56246eec948844bf3be2c970cef09203af32ef8e90f308f"));
        assert(genesis.hashMerkleRoot == uint256S("0xc59bec978b4661ca709e13b492e831e710cd67262fd866608ca30f805bf61c9e"));

        vSeeds.emplace_back("seed1.luckypepe.org");
        vSeeds.emplace_back("seed2.luckypepe.org");
        vSeeds.emplace_back("seed3.luckypepe.org");
        vSeeds.emplace_back("seed4.luckypepe.org");
        vSeeds.emplace_back("seed5.luckypepe.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1740000000, 0, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            consensus.defaultAssumeValid = uint256S("0x0000002a1de0f46379358c1fd09906f7ac59adf3712323ed90eb59e4c183c020");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1740000000, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
