    ...
    QWidget(nullptr, f), curAlignment(0)
{
    ...
    QRect rectIcon(QPoint(10, 35), QSize(250, 250));

    QPixmap icon(":/icons/splash_logo");
    icon = icon.scaled(250*devicePixelRatio, 250*devicePixelRatio, Qt::KeepAspectRatio, Qt::SmoothTransformation);
