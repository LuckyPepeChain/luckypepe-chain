...
const char * const BITCOIN_CONF_FILENAME = "luckypepe.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LuckyPepe";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/LuckyPepe";
#else
    // Unix-like
    return pathRet / ".luckypepe";
#endif
#endif
}
